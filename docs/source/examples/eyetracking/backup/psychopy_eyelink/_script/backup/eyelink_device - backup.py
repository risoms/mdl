...
class Connect(object):
    ...
    def __init__(self, window, edfname):
        ...
        self.tracker.sendMessage("screen_pixel_coords =  0 0 %d %d" %(x_size - 1, y_size - 1))
        self.tracker.sendMessage("DISPLAY_COORDS  0 0 %d %d" %(x_size - 1, y_size - 1))
    ...
    def calibrate(self, cnum=13, paval=1000):
        ...
        genv = calibration_display.calibration_display(self.sres[0], self.sres[1],
