...
var mobile = (function (exports, domGlobals) {
    ...
    var setup = function (realm, editor) {
	  ...
	  // semeon
      var cut = commandSketch('cut');
      var copy = commandSketch('copy');
      var paste = commandSketch('paste');
      var selectall = commandSketch('selectall');
      var save2 = commandSketch('save2');
	  // semeon
	  var link = function () {
      ...
      return {
		//semeon
		cut: feature(Option.none(), cut),
		copy: feature(Option.none(), copy),
		paste: feature(Option.none(), paste),
		selectall: feature(Option.none(), selectall),
		save2: feature(Option.none(), save2),
		//semeon
