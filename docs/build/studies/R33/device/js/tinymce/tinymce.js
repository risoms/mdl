...
(function () {
	(function (domGlobals) {
		...
		var processPlugins = function (isTouchDevice, sectionResult, defaultOverrideSettings, settings) {
		  ...
		  return Tools.extend(settings, { plugins: plugins.join(' ') });
		};
		...
		var combineSettings = function (isTouchDevice, defaultSettings, defaultOverrideSettings, settings) {
		  ...
		  //var extendedSettings = Tools.extend(defaultSettings, defaultOverrideSettings, sectionResult.settings(), false ? getSection(sectionResult, 'mobile', defaultMobileSettings) : {}, {
		  ...
		  var process_ = processPlugins(isTouchDevice, sectionResult, defaultOverrideSettings, extendedSettings);
		  console.log('settings',settings);
		  console.log('defaultSettings',defaultSettings);
		  console.log('defaultMobileSettings',defaultMobileSettings);
		  console.log('sectionResult.settings()',sectionResult.settings());
		  console.log('defaultOverrideSettings',defaultOverrideSettings);
		  console.log('extendedSettings',extendedSettings);
		  console.log('processPlugins',process_);
		...
		var getAll = function () {
		  return {
			'cut':'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"> <style> tspan { white-space:pre } .shp0 { fill: #222f3e } </style> <g id="icomoon-ignore"> </g> <path id="Layer" class="shp0" d="M10.06,6.71c0,0.36 -0.05,0.7 -0.13,1.03l12.88,9.02c0,0 -1.86,2.65 -4.51,0.8l-4.95,-3.68l-3.41,2.39c0.08,0.33 0.13,0.67 0.13,1.03c0,2.45 -1.98,4.43 -4.43,4.43c-2.45,0 -4.43,-1.98 -4.43,-4.43c0,-2.45 1.98,-4.43 4.43,-4.43c1.15,0 2.19,0.45 2.98,1.17l2.2,-2.03l0,0l-0.01,-0.01l-2.19,-2.02c-0.79,0.72 -1.83,1.17 -2.98,1.17c-2.45,0 -4.43,-1.98 -4.43,-4.43c0,-2.45 1.98,-4.43 4.43,-4.43c2.45,0 4.43,1.98 4.43,4.43zM7.79,6.71c0,-1.19 -0.97,-2.16 -2.16,-2.16c-1.19,0 -2.16,0.97 -2.16,2.16c0,1.19 0.97,2.16 2.16,2.16c1.19,0 2.16,-0.97 2.16,-2.16zM7.79,17.29c0,-1.19 -0.97,-2.16 -2.16,-2.16c-1.19,0 -2.16,0.97 -2.16,2.16c0,1.19 0.97,2.16 2.16,2.16c1.19,0 2.16,-0.97 2.16,-2.16zM22.8,7.25l-5.53,3.86l-2.82,-1.98l3.85,-2.68c2.65,-1.86 4.51,0.8 4.51,0.8z" /> </svg>',
			'copy':'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 24" width="24" height="24"> <style> tspan { white-space:pre } .shp0 { fill: #222f3e } </style> <g id="Layer"> <path id="Layer" class="shp0" d="M16,0h-13.33c-1.47,0 -2.67,1.13 -2.67,2.67v14.67h2.67v-14.67h13.33zM8,5.33c-1.47,0 -2.67,1.13 -2.67,2.67v13.33c0,1.53 1.2,2.67 2.67,2.67h9.33c1.47,0 2.67,-1.13 2.67,-2.67v-13.33c0,-1.53 -1.2,-2.67 -2.67,-2.67z" /> </g> </svg>',
			'paste':'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"> <style> tspan { white-space:pre } .shp0 { fill: #222f3e } </style> <g id="icomoon-ignore"> </g> <path id="Layer" class="shp0" d="M24,13.71v9c0,0.71 -0.58,1.29 -1.29,1.29h-12.86c-0.71,0 -1.29,-0.58 -1.29,-1.29v-2.14h-7.29c-0.71,0 -1.29,-0.58 -1.29,-1.29v-18c0,-0.71 0.58,-1.29 1.29,-1.29h14.57c0.71,0 1.29,0.58 1.29,1.29v4.39c0.17,0.11 0.33,0.23 0.48,0.38l5.46,5.46c0.51,0.51 0.91,1.49 0.91,2.2zM13.71,3v-0.86c0,-0.23 -0.2,-0.43 -0.43,-0.43h-9.43c-0.23,0 -0.43,0.2 -0.43,0.43v0.86c0,0.23 0.2,0.43 0.43,0.43h9.43c0.23,0 0.43,-0.2 0.43,-0.43zM10.29,22.29h12v-8.57h-5.57c-0.71,0 -1.29,-0.58 -1.29,-1.29v-5.57h-5.14zM17.14,12h4l-4,-4z" /> </svg>',
			'select-all': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"> <style> tspan { white-space:pre } .shp0 { fill: #222f3e } </style> <g id="icomoon-ignore"> </g> <path id="Layer" class="shp0" d="M6.98,17.02v-10.03h10.03v10.03zM9,9v6h6v-6zM15,5.02v-2.02h2.02v2.02zM15,21v-2.02h2.02v2.02zM18.98,17.02v-2.02h2.02v2.02zM18.98,9v-2.02h2.02v2.02zM18.98,21v-2.02h2.02c0,1.08 -0.94,2.02 -2.02,2.02zM18.98,12.98v-1.97h2.02v1.97zM11.02,21v-2.02h1.97v2.02zM9,3v2.02h-2.02v-2.02zM3,17.02v-2.02h2.02v2.02zM5.02,21c-1.08,0 -2.02,-0.94 -2.02,-2.02h2.02zM18.98,3c1.08,0 2.02,0.94 2.02,2.02h-2.02zM12.98,3v2.02h-1.97v-2.02zM3,9v-2.02h2.02v2.02zM6.98,21v-2.02h2.02v2.02zM3,12.98v-1.97h2.02v1.97zM3,5.02c0,-1.08 0.94,-2.02 2.02,-2.02v2.02z" /> </svg>',
			'save2':'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"> <style> tspan { white-space:pre } .shp0 { fill: #222f3e } </style> <g id="icomoon-ignore"> </g> <path id="Layer" class="shp0" d="M12,10.5v6.79l2.44,-2.44l0.56,0.56l-3.37,3.38l-3.37,-3.37l0.56,-0.56l2.44,2.44v-6.79h-10.5v8.26c0,0.82 0.67,1.49 1.49,1.49h18.76c0.83,0 1.49,-0.67 1.49,-1.5v-8.25h-10.5zM22.5,9.75v-1.5c0,-0.83 -0.67,-1.5 -1.5,-1.5h-9l-1.5,-3h-8.25c-0.83,0 -1.5,0.67 -1.5,1.49v4.51z" /> </svg>',
			'save':'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"> <style> tspan { white-space:pre } .shp0 { fill: #222f3e } </style> <g id="icomoon-ignore"> </g> <path id="Layer" class="shp0" d="M12,10.5v6.79l2.44,-2.44l0.56,0.56l-3.37,3.38l-3.37,-3.37l0.56,-0.56l2.44,2.44v-6.79h-10.5v8.26c0,0.82 0.67,1.49 1.49,1.49h18.76c0.83,0 1.49,-0.67 1.49,-1.5v-8.25h-10.5zM22.5,9.75v-1.5c0,-0.83 -0.67,-1.5 -1.5,-1.5h-9l-1.5,-3h-8.25c-0.83,0 -1.5,0.67 -1.5,1.49v4.51z" /> </svg>',
