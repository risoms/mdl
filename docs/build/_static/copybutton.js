...
const messages = {
  ...
  const addCopyButtonToCodeCells = () => {
	...
	const codeCells = document.querySelectorAll('.input_area div.highlight pre')
	codeCells.forEach((codeCell, index) => {
	  ...
	  `<a class="copybtn o-tooltip--left" style="background-color: ${pre_bg}" data-tooltip="${messages[locale]['copy']}" data-clipboard-target="#${id}">
		<img src="https://mdl.psy.utexas.edu/a/webgazer/i/img/copybutton.svg" alt="${messages[locale]['copy_to_clipboard']}">
	  </a>`
